				...
				$image =$row_customer['customer_image'];
				  ...
				  <form action="" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<td><input type="file" name="c_image"/> <img src="customer/customer_images/<?php echo $image; ?>" width="100" height="100"/></td>
					</tr>
	 ...
	 if(isset($_POST['update'])){
		 ...
		 move_uploaded_file($c_image_tmp,"customer/customer_images/$c_image");
		  ...
		  NID='$NID',customer_address='$c_address',customer_contact='$c_contact',customer_image='$c_image'
